...
//        firstContact.createContact(myTestPerson);
//        firstContact.createContact(new Person("Benchod", testArr));
//        firstContact.createContact(new Person("IbinaldO", testArr2));
//        firstContact.createContact(new Person("Hillary", testArr2));
//        System.out.println(firstContact.lookupContact("ibInaldo"));
...
////        System.out.println(firstContact.deleteContact("Ibinaldo"));
////        System.out.println(firstContact.deleteContact("Ibinaldo"));
////        System.out.println(firstContact.deleteContact("Ibi"));
////        System.out.println(firstContact.deleteContact("Benchod"));
//        System.out.println(Arrays.toString(firstContact.fetchAllNames()));
    }
}
